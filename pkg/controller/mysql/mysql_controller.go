...
import (
	...
	lemonmysqlv1alpha1 "github.com/lemonli/mysql-operator/pkg/apis/lemonmysql/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &lemonmysqlv1alpha1.Mysql{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &lemonmysqlv1alpha1.Mysql{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileMysql) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &lemonmysqlv1alpha1.Mysql{}
	...
	master := pod.Name
	if !reflect.DeepEqual(master, instance.Status.Master) {
		instance.Status.Master = master
...
func newPodForCR(cr *lemonmysqlv1alpha1.Mysql) *corev1.Pod {
